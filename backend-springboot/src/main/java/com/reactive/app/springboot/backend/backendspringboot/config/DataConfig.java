package com.reactive.app.springboot.backend.backendspringboot.config;
...
public class DataConfig {
    ...
    @Bean
    public ReactiveMongoOperations reactiveMongoTemplate(ReactiveMongoDatabaseFactory mongoDbFactory) {
